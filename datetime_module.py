...
tdtt = datetime.datetime(2026,6,12,6,4,2,1000,tzinfo=pytz.UTC)
print(tdtt)

#timezones involvement 
dt_now   = datetime.datetime.now(tz=pytz.UTC)
print(dt_now)
dt_mn = dt_now.astimezone(pytz.timezone('US/Mountain'))

#printing all available timezones 
for tz in pytz.all_timezones:
	pass

#printing datetime in specific format 

dt = dt_mn.strftime('%B %d %Y')
print(dt)
dt_str = 'JULY 20 2016'
